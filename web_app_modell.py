...
study_hours = streamlit.number_input(
    "Lernstunden angeben (wöchentlich):", 
    min_value=0.0, 
    max_value=56.0, 
    value=3.0, 
    step=0.5
...
if study_hours > 8.0:
    streamlit.warning(
        "**Hinweis zur Genauigkeit:** Werte über 8.0 Stunden liegen ausserhalb "
        "der Trainingsdaten. Die vorhergesagte Punktzahl könnte ungenau sein."
    )
